...
class InMemoryTaskManagerTest extends TaskManagerTest<InMemoryTaskManager> {
    ...
    void testIntersectionCheckWorkCorrectly() {
        ...
        assertThrows(IntersectionException.class,()-> manager.addEpic(epic2));
        assertEquals(1, manager.getAllEpics().size(), "Размер не соответствует действительному");
        ...
        assertThrows(IntersectionException.class,()-> manager.addSubtask(subtask2));
        assertEquals(1, manager.getAllSubtasks().size(), "Размер не соответствует действительному");
    }
    ...
    void testShouldGetCorrectEndTime() {
        ...
        assertEquals(task1.getEndTime(), LocalDateTime.of(2025, 3, 16, 10, 10));
